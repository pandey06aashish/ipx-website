      ...
      <div className="bg-white shadow-md rounded-lg p-6 md:p-10 w-full flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-4">
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white py-2 px-4 rounded-md shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Send Message
            </button>
          </form>
